    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(circle, rgba(180, 200, 180, 0.05) 0%, transparent 70%)',
            filter: 'blur(60px)',
          }}
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(80, 160, 145, 0.9) 0%, rgba(56, 130, 120, 0.95) 100%)',
                boxShadow: '0 0 50px rgba(80, 160, 145, 0.2), 0 0 100px rgba(56, 130, 120, 0.1), inset 0 1px 0 rgba(255,255,255,0.1)',
              }}
            >
              <Mic size={36} style={{ color: 'rgba(230, 245, 240, 0.95)' }} />
            </motion.div>
          </button>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            height: '1px',
            background: 'linear-gradient(to right, transparent, rgba(104, 178, 160, 0.2), transparent)',
          }}
        />
          ...
          {features.map((feature, i) => (
            ...
            >
              <div
                ...
                style={{ background: 'rgba(80, 160, 145, 0.15)' }}
              >
                <feature.icon size={14} style={{ color: 'rgba(120, 190, 170, 0.9)' }} />
              </div>
              <div>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.875rem', color: 'rgba(220, 235, 225, 0.85)', fontWeight: '500', marginBottom: '0.25rem' }}>
                  {feature.title}
                </p>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.75rem', color: 'rgba(160, 195, 180, 0.5)', fontWeight: '300', lineHeight: '1.5' }}>
                  {feature.description}
                </p>
              </div>
            </motion.div>
        ...
        {showModal && (
          <>
            <motion.div
              ...
              style={{ background: 'rgba(8, 18, 17, 0.88)', backdropFilter: 'blur(12px)' }}
            />
            <motion.div
            ...
            >
              <button onClick={() => setShowModal(false)} className="absolute top-5 right-5">
                <X size={17} style={{ color: 'rgba(140, 180, 165, 0.4)' }} />
              </button>

              <h2
                className="mb-2"
                style={{ fontFamily: 'var(--font-serif)', fontSize: '1.75rem', color: '#deeee6', fontWeight: '400', lineHeight: '1.2' }}
              >
                Ready to clear<br />your head?
              </h2>
              <p
                className="mb-7"
                style={{ fontFamily: 'var(--font-sans)', fontSize: '0.875rem', color: 'rgba(150, 190, 175, 0.55)', fontWeight: '300', lineHeight: '1.6' }}
              >
              ...
              <div className="space-y-3">
                <button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(80, 160, 145, 0.85), rgba(56, 130, 120, 0.9))',
                    color: 'rgba(230, 245, 240, 0.95)',
                    fontFamily: 'var(--font-sans)',
                    fontWeight: '500',
                    fontSize: '0.9375rem',
